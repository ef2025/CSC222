...
Hints:
Convert integer to a string: String.valueOf(), String.format(), or Integer.toString()
String s = String.valueOf(i); // where i is an integer
...
public class RotationSolution {
    ...
    public static int rotateLeft(int val) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The max rotation is: " + max);
